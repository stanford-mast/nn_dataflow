...
LAYERS['conv8'] = Layer(256, 256, 56, 3)

LAYERS['conv9'] = Layer(256, 512, 28, 3)
LAYERS['conv10'] = Layer(512, 512, 28, 3)
LAYERS['conv11'] = Layer(512, 512, 28, 3)
LAYERS['conv12'] = Layer(512, 512, 28, 3)

LAYERS['conv13'] = Layer(512, 512, 14, 3)
LAYERS['conv14'] = Layer(512, 512, 14, 3)
LAYERS['conv15'] = Layer(512, 512, 14, 3)
LAYERS['conv16'] = Layer(512, 512, 14, 3)
